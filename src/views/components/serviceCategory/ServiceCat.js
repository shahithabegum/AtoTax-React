...
import {GetReturnFrequency} from '../../../service/ReturnFrequencyService'
...
const ServiceCat = (props) => {
  ...
  const [value, setValue] = useState({});
    ...
    const columns = [
      ...
      {title: "ID", field:"id"},
      {title: "Return Type", field:"returnFreqType"},
      ...
      const GetDetails = ()=>{
        GetReturnFrequency().then(res=>setService(res.data.result));
      }
    //   const GoEdit = (item)=>{

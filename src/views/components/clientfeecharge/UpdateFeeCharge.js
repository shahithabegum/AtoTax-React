...
const UpdateFeeCharge = () => {
  ...
  return (
    ...
    <h2 className=' fromheading my-1 p-0 text-center'>Update Client Charge</h2>  
    
    <Row className='my-3 mx-1' >
                    <Col m={6} sm={12} lg={4} ml-0  className='p-1'>
                    <label htmlFor="gstClientId"className="form-label col-sm-12 col-lg-12 p-0 text-lg-right float-sm-left">
    ...
    />
          {formik.touched.previousCharge && formik.errors.previousCharge ? (
     <p style={{color:"red"}}>{formik.errors.previousCharge}</p>
   ) : null}
    </Col>
    </Row>
    <Row className='my-3 mx-1' >
    ...
    <Row className='my-3 mx-1' >
              ...
              {formik.touched.serviceCategoryId && formik.errors.serviceCategoryId ? (
                ...
                <button type="submit" className='btn  btn-outline-info ml-0 col-sm-10 col-lg-4 my-1 float-right' onClick={()=>updateFeeCharge()}>Submit</button>
                
                </Col>
                <Col m={6} sm={12} ml-0 lg={6}>
                <button type="submit" className='btn  btn-outline-danger ml-0 col-sm-10 col-lg-4 my-1 float-left'  onClick={()=>handleCancle()}>Cancel</button>
                  </Col>
                </Row>
    </form>
</div>
